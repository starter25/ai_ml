...
def download_youtube(url):
    yt = YouTube(url)
    name = yt.title.replace(" ", "_").replace("/", "_").replace("|","_").replace("?","_")
    name = re.sub(r'[\U00010000-\U0010FFFF]', '_', name)
...
def main():
    video_path, name = download_youtube('https://www.youtube.com/shorts/JTCvLdcSUeQ')
